<template>
    <div class="space-y-6">
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                <input
                    ...
                    class="flex-1 px-4 py-3 rounded-xl border-2 border-indigo-200 bg-white/50 backdrop-blur-sm focus:ring-2 focus:ring-indigo-400 focus:border-transparent outline-none placeholder:text-slate-400 text-slate-700"
                    @keyup.enter="handleAddPlayer" />
                <button
                    @click="handleAddPlayer"
                    class="px-6 py-3 bg-indigo-500 text-white rounded-xl hover:bg-indigo-600 active:scale-95 transform transition-all duration-200 shadow-lg hover:shadow-xl">
                    Add Player
                </button>
            </div>
            ...
            <div
                ...
                <div
                    ...
                    <button
                        ...
                        class="p-2 text-rose-500 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors">
                        Remove
                    </button>
                </div>
            </div>
        ...
        <div
            v-else
            class="flex items-center justify-between p-4 bg-primary-50 rounded-lg">
            <div class="space-y-1">
                <div
